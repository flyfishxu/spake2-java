...
public class GroupElement implements Serializable {
     ...
     */
    public GroupElement(final Curve curve, final Representation repr, final FieldElement X, final FieldElement Y, final FieldElement Z, final FieldElement T, final boolean precomputeDouble) {
        this(curve, repr, X, Y, Z, T, false, precomputeDouble);
    }

    public GroupElement(final Curve curve, final Representation repr, final FieldElement X, final FieldElement Y, final FieldElement Z, final FieldElement T, final boolean precomputeSingle, final boolean precomputeDouble) {
        this.curve = curve;
        this.repr = repr;
        this.X = X;
        this.Y = Y;
     ...
     * @return The group element in P3 representation.
     */
    public static GroupElement p3(final Curve curve, final FieldElement X, final FieldElement Y, final FieldElement Z, final FieldElement T, final boolean precomputeDoubleOnly) {
